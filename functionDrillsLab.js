...
const jsNinja = () => {
  const ninjaString = 'I am a JavaScript ninja!'
  console.log(ninjaString)
...
//expression - this is my answer. to check my work on other questions I have to comment it out.
...
//arrow - this is my answer. to check my work on other questions I have to comment it out.
...
// declaration - this is my answer. to check my work on other questions I have to comment it out.
...
let movie = bestMovie('Lord of The Rings')
...
function makeUpper(sampleString) {
  let newString = sampleString.toUpperCase()
...
emailCheck('  matthewjackmoon@gmail.com  ')
...
let arrayIsAscending = numsArray(sampleArray)
